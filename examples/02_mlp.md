...
============================================================
  LESSON 2: BACKPROPAGATION AND THE MLP
...
take hours or days to train.
  ...
  The hidden layer transforms each input into a new representation.
  ...
  while different classes separate — the hidden layer has untangled them.
